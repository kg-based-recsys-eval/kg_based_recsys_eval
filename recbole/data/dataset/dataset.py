...
class Dataset:
    ...
    def _from_scratch(self):
        ...
        #print('after _load_data', self.inter_feat.head(2))
        self._init_alias()
        #print('after _init_alias', self.inter_feat.head(2))
        self._data_processing()
        #print('after _data_processing', self.inter_feat.head(2))
    ...
    def _data_processing(self):
        ...
        # #print('END of _build_feat_name_list')
        if self.benchmark_filename_list is None:
            self._data_filtering()
            # #print('after _data_filtering', self.inter_feat.head(2))

        self._remap_ID_all()
        #print('after _remap_ID_all', self.inter_feat.head(2))
        #print('-------')
        #print(self.inter_feat.head(2))
        #print('begin _user_item_feat_preparation')
        self._user_item_feat_preparation()
        #print('after _user_item_feat_preparation', self.inter_feat.head(2))
        self._fill_nan()
        #print('after _fill_nan', self.inter_feat.head(2))
        self._set_label_by_threshold()
        #print('after _set_label_by_threshold', self.inter_feat.head(2))
        self._normalize()
        #print('after _normalize', self.inter_feat.head(2))
        self._preload_weight_matrix()
        #print('after _preload_weight_matrix', self.inter_feat.head(2))
    ...
    def _data_filtering(self):
        ...
        #print('END OF _filter_nan_user_or_item')
        #print(self.inter_feat.head(2))
        self._remove_duplication()
        #print('END OF _remove_duplication')
        #print(self.inter_feat.head(2))
        self._filter_by_field_value()
        #print('END OF _filter_by_field_value')
        #print(self.inter_feat.head(2))
        self._filter_inter_by_user_or_item()
        #print('END OF _filter_inter_by_user_or_item')
        self._filter_by_inter_num()
        #print('END OF _filter_by_inter_num')
        #print('AFTER _filter_by_inter_num', self.inter_feat.head(2))
        self._reset_index()
        #print('END OF _reset_index')
    ...
    def _load_inter_feat(self, token, dataset_path):
        ...
        if self.benchmark_filename_list is None:
            ...
            #print('if', inter_feat_path, inter_feat, '_load_inter_feat')
            #print('_load_inter_feat_end', self.inter_feat.head(2))
        else:
            sub_inter_lens = []
            sub_inter_feats = []
    ...
    def _load_additional_feat(self, token, dataset_path):
        ...
        if self.config['additional_feat_suffix'] is None:
            #print('additional_feat_suffix is None')
            return
        for suf in self.config['additional_feat_suffix']:
    ...
    def _load_feat(self, filepath, source):
        ...
        #print('_load_feat', 'read_csv', filepath, df.head(2))
        df.columns = columns
        ...
        #print('_load_feat', 'before return', df.head(2))
        return df
    ...
    def _filter_by_inter_num(self):
        ...
        #print('user_inter_num_interval', 'item_inter_num_interval', user_inter_num_interval, item_inter_num_interval)
        #print(self.inter_feat.head(2))
        ...
        while True:
            ...
            #print('len ban user ban items', len(ban_users), len(ban_items))
        ...
        #print('DROPPED AFTER', self.inter_feat.head(2))
    ...
    def _reset_index(self):
        ...
        for feat_name in self.feat_name_list:
            ...
            if feat.empty:
                raise ValueError(f'Some feat is empty, please check the filtering settings.')
    ...
    def _get_remap_list(self, field_list):
        ...
        return remap_list
        #print('END of _get_remap_list')

    def _remap_ID_all(self):
        """Remap all token-like fields.
        """
        #print('START _remap_ID_all', self.alias.values(), self._rest_fields)
        for alias in self.alias.values():
            #print(alias)
            remap_list = self._get_remap_list(alias)
            self._remap(remap_list)
        #print('after all alias in _remap_ID_all', self.inter_feat.head(2))
        #print('rest_fields', self._rest_fields)
        for field in self._rest_fields:
            #print('field', field, self._rest_fields)
            remap_list = self._get_remap_list(np.array([field]))
            self._remap(remap_list)
            #print('f', self.inter_feat.head(2))
        #print('END of _remap_ID_all END', self.inter_feat.head(2))
    ...
    def _concat_remaped_tokens(self, remap_list):
        ...
        #print('END of _concat_remaped_tokens', tokens)
    ...
    def _remap(self, remap_list):
        ...
        #print('END OF _remap', self.inter_feat.head(2))
    ...
    def _change_feat_format(self):
        ...
        #print('END of _change_feat_format')
    ...
    def _dataframe_to_interaction(self, data):
        ...
        ##print('END of _dataframe_to_interaction')
