...
# import dgl # NEW
# import dgl.function as dgl_fn # NEW
...
#             g.update_all(dgl_fn.u_mul_e('n', 'w', 'm'), dgl_fn.sum('m', 'n'))
#             g.update_all(dgl_fn.copy_e('w', 'm'), dgl_fn.sum('m', 'ws'))
#             n = g.dstdata['n']
...
#             item_item_graph.apply_edges(dgl_fn.u_dot_v('h',
#  'h', 's'))
