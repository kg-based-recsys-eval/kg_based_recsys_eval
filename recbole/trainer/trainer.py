...
class Trainer(AbstractTrainer):
    ...
    def _train_epoch(self, train_data, epoch_idx, loss_func=None, show_progress=False):
        ...
        # print('SET MODE KGDataLoaderState.RS')
        # train_data.set_mode(KGDataLoaderState.RS) #### CUSTOM

        self.model.train()
        # print('_train_epoch, Trainer')
        ...
        #print('_train_epoch, Trainer, iter_data', iter_data)
        for batch_idx, interaction in enumerate(iter_data):
            #print('batch_idx, interaction', batch_idx, interaction)
